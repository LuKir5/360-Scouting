...
@media screen and (min-width: 960px) {
  ...
  .about-num-text:nth-of-type(1)::before {
    content: "01";
  }

  .about-num-text:nth-of-type(2)::before {
    content: "02";
  }

  .about-num-text:nth-of-type(3)::before {
    content: "03";
  }

  .about-num-text:nth-of-type(4)::before {
    content: "04";
  }
}
