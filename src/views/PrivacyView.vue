...
<template>
  <div class="hero-section-sub">
    ...
    <h1 class="hero-title">Imprint & Privacy Policy</h1>
  </div>
  <div class="privacy-section">
    ...
    <div class="privacy-container">
      <h2 class="section-title mt-3 mb-6">Privacy Policy</h2>
      <p class="text">
        ...
        eu feugiat nulla facilisis. At vero eos et accusam et justo duo dolores
        et ea rebum.<br /><br />
        ...
        elitr, At accusam aliquyam diam diam dolore dolores duo eirmod eos erat,
        et nonumy sed tempor et et invidunt justo labore Stet clita ea et
